                    ...
                    child: Center(
                      ...
                      onPressed: () {
                        Get.toEnd(() => showCupertinoModalPopup(
                            context: context,
                            builder: (context) => getLelang()));
                      },
                      child:
                          Text('Ambil Lelang', style: whiteTextFontTitleBold),
                    )),
                  ),
                )
              ],
            ...
            Stack(
              children: [
                ...
                Container(
                  ...
                  margin: const EdgeInsets.only(top: 270, bottom: 50),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text('Rp. 1.000.000', style: blackfontStayle2),
                      ),
                      const SizedBox(
                        height: 10,
                      ),
                      ...
                      Container(
                        ...
                        child: Text('Rincian Lelang', style: blackfontStayle2),
                      ),
                      Divider(
                        thickness: 1,
                        color: blueColor,
                      ...
                      Row(
                        children: [
                          Padding(
                            padding: const EdgeInsets.only(left: 20),
                            child:
                                Text('Lokasi Lelang', style: blackfontStayle3),
                          ),
                          const SizedBox(
                            width: 22,
                          ),
                          Text(': Celeng, Lohbener', style: blackfontStayle3),
                        ],
                      ),
                      Row(
                        children: [
                          Padding(
                            padding: const EdgeInsets.only(left: 20),
                            child:
                                Text('Waktu Lelang', style: blackfontStayle3),
                          ),
                          const SizedBox(
                            width: 20,
                          ),
                      ...
                      Row(
                        children: [
                          Padding(
                            padding: const EdgeInsets.only(left: 20),
                            child: Text('Kategori', style: blackfontStayle3),
                          ),
                          const SizedBox(
                            width: 53,
                          ),
